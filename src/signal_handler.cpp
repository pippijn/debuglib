...
{
    {
      switch (code)
        {
        case SI_ASYNCNL     : return "asynch name lookup completion";
        case SI_TKILL       : return "tkill or raise";
        case SI_SIGIO       : return "queued SIGIO";
        case SI_ASYNCIO     : return "async I/O completion";
        case SI_MESGQ       : return "a real time message queue state change";
...
static bool
maybe_npe (siginfo_t* si, int pid)
{
  return false;
}
